...
- Rutina "Fábrica: atender pedidos de los 3 paneles" (trig_01ETEnsWsWpTnJYkPrSbLAGc, 7:53, 11:53, 15:53 y 19:53 de Texas): sesión nueva que toma hasta 3 pedidos `nuevo`, los produce o edita y los cierra con `pedido-estado` + `nota` (la respuesta se ve bajo el pedido). Videos terminados de Rave/Karen van a `panel/proyectos/<id>.json` → `videos` (sección "Listos para subir").
