...
- Cola viva (`/clipper#mision`): los pendientes toman los siguientes horarios libres desde ahora (12:00, 3:00, 6:00, 9:30 PM; 4 por día); publicar cualquiera lo saca y todo se reacomoda. "Recién publicados" arriba (por `tiktokAt`). La fecha de `data.json` solo da el orden.
