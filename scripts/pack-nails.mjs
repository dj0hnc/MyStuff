...
const videos = [
  { id: "01-marca", titulo: "", hook: "Uñas lindas en Princeton TX",
    frases: ["¿Vives en Princeton, Texas, y quieres uñas lindas?", "Soy Karen, nail tech.", "Acrílicas, gel, francesas, nail art y macaron gel polish.", "Cada set hecho a tu gusto, con cita y sin prisas.", "Escríbeme por Instagram, karenareyesnails, y agenda tu cita."],
    clave: ["Princeton", "lindas", "Karen", "Acrílicas", "gel", "francesas", "art", "macaron", "gusto", "cita", "Instagram"],
  ...
  { id: "02-tamanos", titulo: "TÚ ELIGES EL TAMAÑO", hook: "Tú eliges el tamaño",
    frases: ["¿Cortas, medianas, largas o extra largas?", "Aquí tú eliges el tamaño y yo le doy vida a tu estilo.", "Acrílicas a tu medida, con la forma que te gusta: cuadradas, coffin o almendra.", "Cuéntame cómo las quieres.", "Escríbeme por Instagram, karenareyesnails."],
  ...
  { id: "03-disenos", titulo: "DISEÑOS Y EXTRAS", hook: "Diseños y extras",
    frases: ["Francesa clásica o francesa negra.", "Baby boomer.", "Flores pintadas a mano.", "Piedras, relieve y hasta print de vaquita.", "Si lo imaginas, lo hacemos. Tus uñas con tu personalidad.", "Escríbeme por Instagram, karenareyesnails, y agenda tu cita."],
  ...
  { id: "04-gel", titulo: "GEL POLISH + MANICURA", hook: "Gel polish con manicura",
    frases: ["¿No quieres acrílicas?", "Gel polish con manicura: uña natural, cuidada y con color que dura semanas.", "Tengo cientos de tonos, incluido el macaron gel polish.", "Rápido, bonito y sin dañar tu uña.", "Escríbeme por Instagram, karenareyesnails."],
  ...
  { id: "05-estudio", titulo: "MI ESTUDIO EN PRINCETON", hook: "Mi estudio en Princeton TX",
    frases: ["Esto no es una mesa en la cocina.", "Es mi estudio en Princeton, Texas: privado, limpio y certificado.", "Tú, tu música y tus uñas, sin prisas y con cita.", "Ven a conocerlo.", "Escríbeme por Instagram, karenareyesnails."],
    clave: ["estudio", "Princeton", "privado", "limpio", "certificado", "música", "uñas", "cita", "conocerlo", "Instagram"],
